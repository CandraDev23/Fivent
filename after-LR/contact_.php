...
if($_SERVER["REQUEST_METHOD"] == "POST") 
{
    $fname = $_POST['fname'];
    $lname = $_POST['lname'];
    $email = $_POST['email-field-contactus'];
    $message = $_POST['message-field-contactus'];
    
    if($fname != "" && $lname != "" && $email != "" && $message != "") 
    {
        $query = mysqli_query($koneksi,"insert into message values('','$fname','$lname','$email','$message')");
...
<body>
        ...
        <div class="wrapper">
            ...
            <div class="menu">
                <ul>
                    ...
                    <li><a href="contact_.php?id=<?php echo $id?>"><b>Contact us</b></a></li>
    ...
    <section>
        <div class="wrapper-contactus">
            <div class="subwrapper-contactus">
                <div class="container-contactus">
                    <h1>Contact Us</h1>
                    <p>Contact Us forms also help reassure customers there's someone listening to complaints and feedback.</p>
                </div>
                <div class="container-contactus1">
                    <form method="POST">
                        <fieldset>
                            <span>
                            <label class="label-FN" for="fname">First name</label>
                            <label class="label-LN" for="lname">Last name</label>
                        </span>
                        <span>
                            <input class="field-FN-contactus" id="field_FN_contactus" type="text" name="fname" placeholder="Your first name">
                            <input class="field-LN-contactus" id="field_LN_contactus" type="text" name="lname" placeholder="Your last name">
                        </span>
                        <br>
                        <label for="">Email</label>
                        <br>
                        <input class="email-field-contactus" type="email" name="email-field-contactus" id="email-field-contactus" placeholder="Your email">
                        <br>
                        <label for="">Message</label>
                        <br>
                        <textarea class="message-field-contactus" type="text" name="message-field-contactus" id="message-field-contactus" placeholder="Your message" cols="30" rows="10"></textarea>
                        <div class="div-space-buttonsend"></div>
                        <input class="button-send-contactus" type="submit" value="Send">
                        </fieldset>
                    </form>
                </div>
            </div>
