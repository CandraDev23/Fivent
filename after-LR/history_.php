        ...
        <div class="wrapper">
            ...
            <div class="menu">
                <ul>
                    ...
                    <li><a href="history_.php?id=<?php echo $id?>"><b>History</b></a></li>
        ...
        <div class="wrapper-history">
            <div class="subwrapper-history-search">
                <div class="container-history">
                    ...
                    <div class="field-sect">
                        <input class="fieldsearch-history" type="search" name="" id="" placeholder="Enter an event name">
                        <button class="search-button-history">
            ...
            <div class="subwrapper-history">
                <div class="subwrapper-history-1">
                    ...
                    $query = "SELECT * FROM history_event WHERE id_user = '$id'";
                    ...
                    ?>
                    <a href="detailevent-history.php?id=<?php echo $id?>&id_event=<?php echo $id_event?>">
